...
class pendientesController extends Controller
{
    public function PendientesxVend(Request $request){
		$pendientes = DB::select('SELECT c.id, c.id_vendedor, v.nombre as nomvend, c.tipo, c.id_categoria, ca.nombre as nomcatego,
										 c.fecha, c.hora, c.fecha_cierre, c.hora_cierre, c.id_cliente,cli.nombre as nomcli, cli.tel1, c.comentarios,
