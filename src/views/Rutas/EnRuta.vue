<!-- <template>
	<v-content class="pa-0" >
		<v-row>
			<v-btn color="rosa" style="display: none" class="ir-arriba white--text" small fab fixed bottom left> 
			...
			<v-col cols="12"  v-if="ruta1.length" > 
				<v-card> 
					<v-card-actions> 
			...
			<v-col cols="12"  v-if="ruta2.length" > 
				<v-card> 
					<v-card-actions> 
			...
			<v-col cols="12" v-if="ruta3.length"  > 
				<v-card> 
					<v-card-actions> 
			...
			<v-col cols="12" v-if="ruta4.length" > 
				<v-card> 
					<v-card-actions> 
